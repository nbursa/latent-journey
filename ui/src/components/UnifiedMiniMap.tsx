...
export default function UnifiedMiniMap({
  ...
  return (
    ...
    >
      ...
      <div
        className={`p-2 text-xs text-ui-dim flex items-center justify-between ${
          !isMinimized ? "border-b border-ui-border" : ""
        }`}
      >
        ...
        <button
          ...
          className="px-1 py-0.5 text-xs rounded transition-colors btn-primary"
          ...
          {cameraPosition && (
            <div
              ...
              style={{
                ...
                top: `${Math.max(
                  0,
                  Math.min(100, cameraY - viewportSize / 2)
                )}%`,
                width: `${viewportSize}%`,
                height: `${viewportSize}%`,
                transform: "translate(-50%, -50%)",
