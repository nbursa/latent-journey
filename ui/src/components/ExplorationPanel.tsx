...
export interface ExplorationPanelRef {
  reset: () => void;
}

const ExplorationPanel = forwardRef<ExplorationPanelRef, ExplorationPanelProps>(
  (
    {
      memoryEvents,
      onFilterChange,
    ...
    // Reset function to reset all internal state
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <div className="flex gap-1 flex-wrap">
                {["all", "vision", "speech", "stm", "ltm"].map((source) => (
                  <button
                    key={source}
...
ExplorationPanel.displayName = "ExplorationPanel";
