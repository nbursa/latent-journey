...
export default function App() {
  ...
  const [memoryFilter, setMemoryFilter] = useState<"all" | "speech" | "vision">(
    "all"
  );
  const [selectedMemoryEvent, setSelectedMemoryEvent] =
    useState<MemoryEvent | null>(null);
        ...
        <div className="flex-1 flex flex-col min-h-0">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex gap-1">
              ...
              <button
                onClick={() => setMemoryFilter("speech")}
                className={`px-2 py-1 text-xs flat ${
              ...
              <button
                onClick={() => setMemoryFilter("vision")}
                className={`px-2 py-1 text-xs flat ${
